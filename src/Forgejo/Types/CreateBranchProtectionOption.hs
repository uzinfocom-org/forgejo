...
module Forgejo.Types.CreateBranchProtectionOption
  ( CreateBranchProtectionOption (..)
  , CreateBranchProtectionOptionPayload (..)
  ) where
...
instance FromJSON CreateBranchProtectionOption where
  parseJSON = withObject "CreateBranchProtectionOption" $ \o ->
    CreateBranchProtectionOption
      <$> o .: "apply_to_admins"
...
instance ToJSON CreateBranchProtectionOption where
  toJSON = genericToJSON runOptions

data CreateBranchProtectionOptionPayload = CreateBranchProtectionOptionPayload
  { arpAction :: Text
  , arpRun :: CreateBranchProtectionOption
  , arpPriorStatus :: Text
  }
  deriving stock (Eq, Generic, Show)

instance FromJSON CreateBranchProtectionOptionPayload where
  parseJSON = withObject "CreateBranchProtectionOptionPayload" $ \o ->
    CreateBranchProtectionOptionPayload
      <$> o .: "action"
      <*> o .: "run"
      <*> o .: "prior_status"

instance ToJSON CreateBranchProtectionOptionPayload where
